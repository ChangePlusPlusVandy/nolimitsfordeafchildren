...
import LoginPage from './domains/global/pages/LoginPage.tsx'
      ...
      <QueryClientProvider client={queryClient}>
        <BrowserRouter>
          <Routes>
            ...
            <Route path="/students/:id/link-teacher" element={<LinkTeacherModal />} />
            <Route path="/students/:id/upload" element={<UploadDocumentModal />} />
