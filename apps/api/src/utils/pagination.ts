...
export function normalizeLimit(limit?: number, defaultLimit: number = 20, maxLimit: number = 100): number {
...
export function getPagination(query: PaginatedQuery, defaultLimit: number = 20, maxLimit: number = 100) {
