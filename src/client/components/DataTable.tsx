...
/**
 * Enhanced DataTable (ported from the legacy Vite app) with responsive column
 * hiding, error alert + retry, and an empty state.
 */
export function DataTable({
  ...
  if (error) {
    return <ErrorAlert message="Failed to load records." onRetry={onRetry} />;
  }
