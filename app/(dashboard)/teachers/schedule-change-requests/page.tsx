...
import {
  ...
  HelpOutlined as ConditionalIcon,
...
import {
  ...
  teacherRespondToScheduleChange,
} from "@/client/schedule-changes";
...
export default function TeacherScheduleChangeRequestsPage() {
  ...
  const respondMutation = useMutation({
    mutationFn: (payload: {
      ...
      teacherRespondToScheduleChange(payload.requestId, {
  ...
  const items = (data?.items ?? []) as unknown as ScheduleChangeRequest[];
