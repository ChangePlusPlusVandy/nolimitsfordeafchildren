          ...
          <Stack direction={{ xs: "column", sm: "row" }} spacing={2}>
            ...
            <Box sx={{ flex: 1 }}>
              ...
              {requestedSchedule ? (
                ...
                <Card
                  variant="outlined"
                  sx={{ p: 1.5, bgcolor: "info.50", borderColor: "info.light" }}
                >
                  <Stack spacing={0.5}>
...
export default function MyRequestsPage() {
  ...
  const {
    ...
    queryFn: () => listMakeupRequestsForParent({ page: makeupPage, limit: rowsPerPage }),
  });
  ...
  const {
    ...
    queryFn: () => listScheduleChangeRequestsForParent({ page: schedulePage, limit: rowsPerPage }),
  });

  const makeupRequests: MakeupRequest[] = (makeupData?.items ?? []) as unknown as MakeupRequest[];
  const scheduleChangeRequests: ScheduleChangeRequest[] = (scheduleChangeData?.items ??
    []) as unknown as ScheduleChangeRequest[];
          ...
          {tabValue === 1 &&
            (scheduleChangeLoading ? (
              ...
              <EmptyState
                ...
                onAction={() => router.push("/parents/schedule-change")}
              />
            ) : (
              <>
